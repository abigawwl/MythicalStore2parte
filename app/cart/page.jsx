...
import CartItemSkelton from '../cart/CartItemSkelton';
                    ...
                    <div className="mt-8">
                        {loading ? <CartItemSkelton /> : (
                            <>
                                ...
                                <h2 className='text-gray-400 text-[14px]'>Note: All the digital content will be sent to your registered email address</h2>
                            </>
                        )}
                    </div>
                </div>
